...
//             </div>
//         </div>
//         <h2 className='font-bold text-primary txt-lg'>
//                 Rs. {budget.amount}
//             </h2>
//             </div>
//             <div className='mt-5'>
...
function BudgetItem({ budget }) {
  ...
  return (
    <Link href={'/dashboard/expenses/' + budget?.id} className='p-5 border rounded-lg hover:shadow-md cursor-pointer h-[170px] flex flex-col'>
      <div className='flex gap-2 items-center justify-between'>
        <div className='flex gap-2 items-center'>
          <h2 className='text-2xl p-3 px-4 bg-slate-100 rounded-full'>
            {budget?.icon}
        ...
        <h2 className='font-bold text-primary txt-lg'>Rs. {budget.amount}</h2>
      </div>
      <div className='mt-5'>
        <div className='flex items-center justify-between mb-3'>
